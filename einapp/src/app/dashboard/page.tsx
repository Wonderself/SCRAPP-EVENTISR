...
export default function DashboardPage() {
  ...
  return (
    <div className={`min-h-screen pb-28 ${isDay ? "bg-sky-100" : "bg-[#0d0820]"}`}>
      ...
      {/* ===== CONTENT ===== */}
      <div className="px-3 lg:px-12 max-w-4xl mx-auto -mt-8 space-y-3 lg:space-y-6 relative z-10">
        ...
        <div className="grid grid-cols-2 gap-2.5 lg:gap-4">
          <button
            ...
            className={`cartoon-btn rounded-3xl p-3 lg:p-6 flex flex-col items-center gap-1.5 lg:gap-3 animate-slide-right no-color-transition ${
              isDay
          ...
          >
            <div className="relative">
              <div
                className={`w-10 h-10 lg:w-16 lg:h-16 rounded-2xl lg:rounded-3xl flex items-center justify-center animate-heartbeat no-color-transition ${
                  isDay
